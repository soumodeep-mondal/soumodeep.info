...
<header id="header">
  <div class="d-flex flex-column">
    ...
    <nav id="navbar" class="nav-menu navbar">
      <ul>
        <li><a href="#" class="nav-link active"><i class="bx bx-home"></i> <span>Dashboard</span></a></li>
...
<div class="container-fluid">
  ...
  <div class="table-name">Motion Database</div>   
      <table>
        <tr>
          <th>ID</th>
        ...
        <?php
        $sql="SELECT * FROM `motion_uploadform` WHERE 1";
        $query=mysqli_query($conn,$sql);
        while($motiondisplay=mysqli_fetch_assoc($query)) 
        {?>
            <tr>
                <td><?php echo $motiondisplay['id'];?></td>
                <td><?php echo $motiondisplay['Title_motion'];?></td>
                <td><?php echo $motiondisplay['subtitle_motion'];?></td>
                <td class="imgdisplay-size"><img src="../assets/img/portfolio/motion/<?php echo $motiondisplay ['Image_motionfile'] ?>" class="img-fluid" alt=""></td>
                <td><?php echo $motiondisplay['project_information_sql'];?></td>
                <td><?php echo $motiondisplay['category_sql'];?></td>
                <td><?php echo $motiondisplay['client_sql'];?></td>
                <td><?php echo $motiondisplay['date_sql'];?></td>
                <td><?php echo $motiondisplay['url_sql'];?></td>
                <td><?php echo $motiondisplay['title_details_sql'];?></td>
                <td><a href="motion-update.php?id=<?php echo $motiondisplay['id'];?>"><button type="button" class="btn btn-success">Update</button></td></a>
                

                <input type="hidden" class="delete_id_value" value="<?php echo $motiondisplay['id'];?>">
...
<!-- Connect to contact mail File -->
  ...
  <!-- motion-manage-alert File -->
  <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
  <script src="js/motion-manage-alert.js"></script>
  </body>
  </html>