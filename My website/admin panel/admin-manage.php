...
<!-- ======= Hero Section ======= -->
  <div class="container-fluid"> 
    <div class="manage-body">
      <div class="new-register-btn"><a href="admin-register.php"><button type="button" class="btn btn-primary">New Register</button></a></div>
    <div class="table-name">Admin Database</div>
        ...
        <tr>
          ...
          <?php
          $sql="SELECT * FROM `admin-login` WHERE 1";
          $query=mysqli_query($conn,$sql);
          while($admindisplay=mysqli_fetch_assoc($query)) 
          {?>
              <tr>
                  <td><?php echo $admindisplay['id'];?></td>
                  <td><?php echo $admindisplay['user_sql'];?></td>
                  <td><?php echo $admindisplay['pass_sql'];?></td>
                  <td><a href="admin-update.php?id=<?php echo $admindisplay['id'];?>"><button type="button" class="btn btn-success">Update</button></a></td>
                  <td><a href="admin-delete.php?id=<?php echo $admindisplay['id'];?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
