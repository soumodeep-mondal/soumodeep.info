...
<div class="container-fluid ">
  <div class="manage-body">
    <div class="table-name">Web Database</div>   
    <table>
      <tr>
        <th>ID</th>
      ...
      <?php
      $sql="SELECT * FROM `web_uploadform` WHERE 1";
      $query=mysqli_query($conn,$sql);
      while($webdisplay=mysqli_fetch_assoc($query)) 
      {?>
        <tr>
            <td><?php echo $webdisplay['id'];?></td>
            <td><?php echo $webdisplay['Title_webimg'];?></td>
            <td><?php echo $webdisplay['subtitle_web'];?></td>
            <td class="imgdisplay-size"><img src="../assets/img/portfolio/web/<?php echo $webdisplay ['Image_webfile'] ?>" class="img-fluid" alt=""></td>
            <td><?php echo $webdisplay['project_information_sql'];?></td>
            <td><?php echo $webdisplay['category_sql'];?></td>
            <td><?php echo $webdisplay['client_sql'];?></td>
            <td><?php echo $webdisplay['date_sql'];?></td>
            <td><?php echo $webdisplay['url_sql'];?></td>
            <td><?php echo $webdisplay['title_details_sql'];?></td>
            <td><a href="web-update.php?id=<?php echo $webdisplay['id'];?>"><button type="button" class="btn btn-success">Update</button></td></a>
           

            <input type="hidden" class="delete_id_value" value="<?php echo $webdisplay['id'];?>">
...
<!-- Connect to contact mail File -->
  ...
  <!-- web-manage-alert File -->
  <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
  <script src="js/web-manage-alert.js"></script>
  </body>
  </html>