...
<head>
  ...
  <title>Graphics Database</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="https://img.icons8.com/metro/26/null/data-configuration.png" rel="icon">
  <link href="https://img.icons8.com/metro/26/null/data-configuration.png" rel="apple-touch-icon">
...
<div class="container-fluid">
  ...
  <div class="table-name">Graphics Database</div>   
      <table>
        <tr>
          <th>ID</th>
          <th>Title_graphics</th>
          <th>subtitle_graphics</th>
          <th>Image_graphicsfile</th>
          <th>project_information_sql</th>
          <th>category_sql</th>
          <th>client_sql</th>
          <th>date_sql</th>
          <th>url_sql</th>
          <th>title_details_sql</th>
          <th>Update row</th>
          <th>Delete row</th>
        </tr>
          <?php
          $sql="SELECT * FROM `graphics_uploadform` WHERE 1";
          $query=mysqli_query($conn,$sql);
          while($graphicsdisplay=mysqli_fetch_assoc($query)) 
          {?>
              <tr>
                  <td><?php echo $graphicsdisplay['id'];?></td>
                  <td><?php echo $graphicsdisplay['Title_graphics'];?></td>
                  <td><?php echo $graphicsdisplay['subtitle_graphics'];?></td>
                  <td><div class="imgdisplay-size"><img src="../assets/img/portfolio/graphics/<?php echo $graphicsdisplay ['Image_graphicsfile'] ?>" class="img-fluid" alt=""></div></td>
                  <td><?php echo $graphicsdisplay['project_information_sql'];?></td>
                  <td><?php echo $graphicsdisplay['category_sql'];?></td>
                  <td><?php echo $graphicsdisplay['client_sql'];?></td>
                  <td><?php echo $graphicsdisplay['date_sql'];?></td>
                  <td><?php echo $graphicsdisplay['url_sql'];?></td>
                  <td><?php echo $graphicsdisplay['title_details_sql'];?></td>
                  <td><a href="graphics-update.php?id=<?php echo $graphicsdisplay['id'];?>"><button type="button" class="btn btn-success">Update</button></td></a>

                  <input type="hidden" class="delete_id_value" value="<?php echo $graphicsdisplay['id'];?>">
                  <td><a href="javascripit:void(0)" class="delete_btn_ajax btn btn-danger">Delete</a></td>
              </tr> 
...
<!-- Connect to contact mail File -->
  ...
  <!-- graphics-manage-alert File -->
  <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
  <script src="js/graphics-manage-alert.js"></script>
  </body>
  </html>